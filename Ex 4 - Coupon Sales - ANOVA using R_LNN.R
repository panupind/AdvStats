...
qqnorm(df$sales, pch = 22, cex=0.9) #pch plotting character for points, cex is for expanding the size of plotted symbols
...
leveneTest(df$sales~df$promotion)  # prerequstie for the test is to load car package
